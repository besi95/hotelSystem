...
<div id="wrapper" class="toggled">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li><a class="menu-active" href="menaxhimi_dhomave.php">Menaxho Dhomat</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p data-placement="top">
                                            ...
                                            <a href="<?php echo 'mbyll_dhomen.php?rezId=' . $dhoma['rezervim_id'] ?>">
...
<script type="text/javascript">
    ...
    $('.edit-button').click(function(){
        ...
        if(statusDhoma == 0){
            ...
            $('.forma-editimit #ora_hyrjes').val('<?php echo date('H:i:s')?>');
            $('.forma-editimit #cmimi_dhomes').val($.trim($('#cmimi-room-'+rezervimId).html()));
            $('.forma-editimit #status_dhome').val(statusDhoma);
        }
    });
