    ...
    <div id="page-content-wrapper">
        <div class="container-fluid" id="mbyll-dhomen-fature">
            ...
            <div class="fatura-dhomes">
                ...
                <p><b>Ore Total: </b><?php echo llogaritOret($dhoma['ora_hyrjes'],date('Y-m-d H:i:s'))?></p>
        ...
        <div>
           ...
           <a href="app/mbyllDhomen.php?rezId=<?php echo $rezervimId?>" onclick="return confirm('Jeni i sigurte qe deshironi te mbyllni dhomen?')"><button type="button" class="btn btn-danger btn-lg" style="width: 45%;"><span
